                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/task">
                        ...
                        <div class="form-group{{ $errors->has('public') ? ' has-error' : '' }}">
                            <div class="col-md-6">
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="public" {{ old('public') ? 'checked' : '' }}> Public
                                        </label>
                                    </div>
                        ...
                        <div class="form-group{{ $errors->has('starttime') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="starttime" type="datetime-local" class="form-control" name="starttime" value="{{ old('starttime') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('endtime') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="endtime" type="datetime-local" class="form-control" name="endtime" value="{{ old('endttime') }}" required>
